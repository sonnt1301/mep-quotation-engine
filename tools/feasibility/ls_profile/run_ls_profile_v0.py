...
def main():
    parser = argparse.ArgumentParser(description="Run LS Supplier Profile Parser v0.")
    parser.add_argument(
        "--pdf-path", 
    ...
    print(f"Executing LS Supplier Profile Parser v0 on {len(target_pages)} pages...")
    ...
    with pdfplumber.open(pdf_path) as pdf:
        for page_num in target_pages:
            ...
            try:
                raw_items = parse_page(page, page_num)
                ...
                for item in raw_items:
                    ...
                    if is_valid:
                        ...
                        invalid_record = {
                            ...
                            "raw_item": item.to_dict(), # Gọi to_dict() sau khi đã cập nhật errors và validation_status để đồng bộ hóa
                            "errors": errors,
                            "warnings": warnings
                        }
