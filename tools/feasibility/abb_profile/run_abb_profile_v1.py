...
def main():
    parser = argparse.ArgumentParser(description="Run ABB Supplier Profile Parser v1.")
    parser.add_argument(
        "--pdf-path", 
    ...
    output_dir = Path("D:/mep_quotation_pipeline/feasibility_outputs/abb_profile_v1")
    ...
    print(f"Executing ABB Supplier Profile Parser v1 on {len(target_pages)} pages...")
    ...
    with pdfplumber.open(pdf_path) as pdf:
        for page_num in target_pages:
            ...
            try:
                raw_items, pf, layout, raw_detected, skipped = parse_page(page, page_num)
