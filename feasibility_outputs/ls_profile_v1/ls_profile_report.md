...
* **Số trang PASS (Tỷ lệ lỗi <= 5% và Valid >= 10)**: 3 trang
* **Số trang PARTIAL (Có valid item nhưng tỷ lệ lỗi > 5%)**: 2 trang
* **Số trang FAIL (Không có valid item)**: 0 trang
* **Tổng số vật tư thô (Raw)**: 301 items
* **Tổng số vật tư hợp lệ (Valid)**: 282 items
* **Tổng số vật tư lỗi bị loại (Invalid)**: 19 items
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | PASS | 73 | 6 | 67 | 67 | 0 | 0.0% | None |
| 2 | PARTIAL | 67 | 24 | 43 | 33 | 10 | 23.3% | material_code_invalid_format |
| 3 | PASS | 80 | 9 | 71 | 69 | 2 | 2.8% | material_code_invalid_format |
| 4 | PASS | 85 | 21 | 64 | 63 | 1 | 1.6% | material_code_invalid_format |
| 5 | PARTIAL | 63 | 7 | 56 | 50 | 6 | 10.7% | material_code_invalid_format |
...
| --- | --- | --- | --- | --- |
| 1 | Trang 2 | CUỘN | PHỤ KIỆN CẦU DAO ĐIỆN (MCCB) Cuộn đóng ngắt In=for ABN100c~ABH250c | material_code_invalid_format |
| 2 | Trang 2 | UNDER | PHỤ KIỆN CẦU DAO ĐIỆN (MCCB) Under Vol. Trip In=for ABN403c~803c | material_code_invalid_format |
| 3 | Trang 2 | TIẾP | PHỤ KIỆN CẦU DAO ĐIỆN (MCCB) Tiếp điểm phụ In=for ABN100c~ABH250c | material_code_invalid_format |
| 4 | Trang 2 | AUXILIARY | PHỤ KIỆN CẦU DAO ĐIỆN (MCCB) Auxiliary switch In=for ABN403c~803c | material_code_invalid_format |
| 5 | Trang 2 | AX | PHỤ KIỆN CẦU DAO ĐIỆN (MCCB) (AX) In=for ABS1003b~1204b | material_code_invalid_format |
...
* **Kết quả**: Bóc tách thành công 282 items hợp lệ với tỷ lệ lỗi thấp, chứng minh khả năng tái sử dụng của hướng đi Coordinate Column Profiler.
